...
const buttonVariants = cva(
  // cursor-pointer + active press states (M9 round 2): Tailwind v4 preflight
  // no longer gives buttons a pointer cursor, and every button site-wide
  // should visibly react when pressed.
